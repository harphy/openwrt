...
define Device/librelink_ac1200
  IMAGE_SIZE := 16064k
  KERNEL_LOADADDR := 0x81000000
  KERNEL := kernel-bin | append-dtb | relocate-kernel $$(loadaddr-y) | \
	lzma | uImage lzma
  ...
  IMAGE/factory.bin := append-kernel | pad-to $$$$(BLOCKSIZE) | \
	append-rootfs | pad-rootfs
  DEVICE_PACKAGES := kmod-mt7615e kmod-mt7663-firmware-ap swconfig
endef
TARGET_DEVICES += librelink_ac1200

define Device/librelink_n300
  IMAGE_SIZE := 16064k
  KERNEL_LOADADDR := 0x81000000
  KERNEL := kernel-bin | append-dtb | relocate-kernel $$(loadaddr-y) | \
	lzma | uImage lzma
